...
class Struct : public SimpleReferenceType<StructValue> {
 public:
  ...
  void TraverseCollectableFields(Collectable* collectable, CollectableVisitor* visitor) override {
...
class Module {
 public:
  ...
  Result<void> PutProcedure(Procedure* proc, NativeProcedure native_impl);
