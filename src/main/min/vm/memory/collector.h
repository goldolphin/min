...
class Collectable final {
 public:
  ...
  explicit Collectable(CollectableType* type);
...
class CollectableType {
 public:
  ...
  virtual void InitializeValue(Collectable* collectable) = 0;
  virtual void FinalizeValue(Collectable* collectable) = 0;
  virtual void TraverseCollectableFields(Collectable* collectable, CollectableVisitor* visitor) = 0;
...
class Collector {
 public:
  ...
  virtual Result<Collectable*> New(CollectableType* type, CollectorRootScanner* root_scanner) = 0;
